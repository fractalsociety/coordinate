...
fn test_adaptive_assignment_reassigns_too_large_claude_role_task_to_codex() {
    ...
    broad.description = "Review the full architecture, summarize the PRD, and write docs.".to_string();
    ...
    assert_eq!(assigned[0].assigned_role.as_deref(), Some("claude_coding_worker"));
}
